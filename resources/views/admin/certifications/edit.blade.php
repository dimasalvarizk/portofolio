...
<div class="row justify-content-center">
    <div class="col-lg-8">
        ...
        <div class="d-flex align-items-center gap-2 mb-4">
            ...
            <div>
                <h1 class="page-header-title mb-0">Edit Sertifikat</h1>
                <p class="page-header-subtitle">Perbarui data sertifikat kompetensi atau lisensi keahlian Anda.</p>
            </div>
        </div>
            ...
            <div class="card-body p-4 p-md-5">
                <form action="{{ route('admin.certifications.update', $certification->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" id="issuer" name="issuer" value="{{ old('issuer', $certification->issuer) }}" required placeholder="Contoh: Dicoding Indonesia, Coursera, atau BPPTIK Kominfo" autocomplete="off">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="url" class="form-control" id="link" name="link" value="{{ old('link', $certification->link) }}" placeholder="https://dicoding.com/certificates/xxx" autocomplete="off">
                    </div>

                    <div class="mb-5">
                        <label for="icon" class="form-label">Ikon (Font Awesome class - Opsional)</label>
                        <input type="text" class="form-control" id="icon" name="icon" value="{{ old('icon', $certification->icon) }}" placeholder="Contoh: fas fa-certificate" autocomplete="off">
                    ...
                    <div class="d-flex gap-3 justify-content-end align-items-center">
                        ...
                        <button type="submit" class="btn-pricing-blue">
                            <i class="fas fa-arrows-rotate me-1"></i> Perbarui Sertifikat
                        </button>
                    </div>
                </form>
            </div>
