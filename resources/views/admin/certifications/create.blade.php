...
<div class="row justify-content-center text-white animate__animated animate__fadeIn">
    <div class="col-lg-8">
        ...
        <div class="d-flex align-items-center gap-3 mb-4">
            ...
            <div>
                <h2 class="fw-bold mb-1">Tambah Sertifikat Baru</h2>
                <p class="text-secondary mb-0" style="color: #cbd5e1 !important;">Tambahkan data sertifikat kompetensi baru ke portofolio Anda.</p>
            </div>
        </div>
        ...
        <div class="glass-card p-5">
            <form action="{{ route('admin.certifications.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control" id="issuer" name="issuer" value="{{ old('issuer') }}" required placeholder="Contoh: Dicoding Indonesia atau BPPTIK Kominfo" autocomplete="off">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control" id="link" name="link" value="{{ old('link') }}" placeholder="Contoh: https://dicoding.com/certificates/xxx" autocomplete="off">
                </div>

                <div class="mb-4">
                    <label for="icon" class="form-label">Ikon (Font Awesome class - Opsional)</label>
                    <input type="text" class="form-control" id="icon" name="icon" value="{{ old('icon', 'fas fa-certificate text-warning') }}" placeholder="Contoh: fas fa-certificate text-warning" autocomplete="off">
                </div>

                <div class="text-end">
                    <button type="submit" class="btn btn-glow-primary px-5 py-3">
                        <i class="fas fa-save me-2"></i> Tambah Sertifikat
                    </button>
                </div>
            </form>
        </div>
