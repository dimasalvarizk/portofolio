...
@section('title', 'Edit Riwayat Timeline')
...
<div class="row justify-content-center text-white animate__animated animate__fadeIn">
    <div class="col-lg-8">
        ...
        <div class="d-flex align-items-center gap-3 mb-4">
            ...
            <div>
                <h2 class="fw-bold mb-1">Edit Riwayat Timeline</h2>
                <p class="text-secondary mb-0" style="color: #cbd5e1 !important;">Perbarui detail entitas pendidikan atau pengalaman kerja.</p>
            </div>
        </div>
        ...
        <div class="glass-card p-5">
            <form action="{{ route('admin.experiences.update', $experience->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control" id="subtitle" name="subtitle" value="{{ old('subtitle', $experience->subtitle) }}" required placeholder="Contoh: PT Tokopedia atau Universitas Muhammadiyah Purwokerto" autocomplete="off">
                </div>

                <div class="mb-4">
                    <label for="period" class="form-label">Periode Waktu</label>
                    <input type="text" class="form-control" id="period" name="period" value="{{ old('period', $experience->period) }}" required placeholder="Contoh: Sep 2024 - Des 2024 atau 2022 - 2026" autocomplete="off">
                </div>

                <div class="mb-4">
                    <label for="description" class="form-label">Deskripsi / Detail Kegiatan (Opsional)</label>
                    <textarea class="form-control" id="description" name="description" rows="4" placeholder="Jelaskan kontribusi, tugas, atau capaian Anda selama periode ini...">{{ old('description', $experience->description) }}</textarea>
                </div>

                <div class="text-end">
                    <button type="submit" class="btn btn-glow-primary px-5 py-3">
                        <i class="fas fa-save me-2"></i> Perbarui Riwayat
                    </button>
                </div>
            </form>
        </div>
